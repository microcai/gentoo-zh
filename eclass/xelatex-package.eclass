...
# $Header: /var/cvsroot/gentoo-x86/eclass/xelatex-package.eclass,v 1.33 2008/02/17 19:03:07 aballier Exp $
		...
		case $1 in
			...
			"tex" | "dtx")
				...
				do
					...
					texi2dvi -q -c --language=xelatex $i &> /dev/null
					done
				;;
			"tfm" | "vf" | "afm")
				for i in `find . -maxdepth 1 -type f -name "*.${1}"`
