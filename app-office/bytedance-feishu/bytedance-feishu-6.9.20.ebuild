...
CDN_URL="https://sf3-cn.feishucdn.com/obj/ee-appcenter"

DESCRIPTION="feishu - ByteDance's enterprise collaboration platform"
HOMEPAGE="https://www.feishu.cn/"
SRC_URI="
	amd64?	( ${CDN_URL}/6085d1c4/Feishu-linux_x64-${PV}.deb )
	arm64?	( ${CDN_URL}/116f4e13/Feishu-linux_arm64-${PV}.deb )
	mips?	( ${CDN_URL}/2bc53590/Feishu-linux_mips64el-${PV}.deb )
"
