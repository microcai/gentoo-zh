...
9cfd93b10ee81b2fc3ad26357f27ed13/TencentMeeting_0300000000_${PV}_x86_64_default.publish.officialwebsite.deb -> ${P}_amd64.deb )
	arm64? ( https://updatecdn.meeting.qq.com/cos/\
e5f447f30343e27c49438db8d035ae23/TencentMeeting_0300000000_${PV}_arm64_default.publish.officialwebsite.deb -> ${P}_arm64.deb )
	loong? ( https://updatecdn.meeting.qq.com/cos/\
9f89b7a489e65e457308d6bf2ed505db/TencentMeeting_0300000000_${PV}_loongarch64_default.publish.officialwebsite.deb -> ${P}_loongarch64.deb )
"
