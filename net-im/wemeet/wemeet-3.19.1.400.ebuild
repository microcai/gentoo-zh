...
AMD64_URI="${TENCENT_URI}/fcdc2a010a25561a4d23e168b677b493"
ARM64_URI="${TENCENT_URI}/73805834f20680c804310bd0e80f269d"
LOONG_URI="${TENCENT_URI}/bc71f68ac41d78667c10b10913949b88"

SRC_URI="
	amd64? ( ${AMD64_URI}/TencentMeeting_0300000000_${PV}_x86_64_default.publish.deb -> ${P}_amd64.deb )
	arm64? ( ${ARM64_URI}/TencentMeeting_0300000000_${PV}_arm64_default.publish.deb -> ${P}_arm64.deb )
	loong? ( ${LOONG_URI}/TencentMeeting_0300000000_${PV}_loongarch64_default.publish.deb -> ${P}_loongarch64.deb )
"
