...
SRC_URI="
         ...
         https://github.com/HougeLangley/customkernel/releases/download/v5.12-patch/0001-patch-5.12.1-xanmod1-cacule.xz
         ${GENPATCHES_URI}
"

src_unpack() {
    UNIPATCH_LIST_DEFAULT=""
    UNIPATCH_LIST="${DISTDIR}/0001-patch-5.12.1-xanmod1-cacule.xz"
