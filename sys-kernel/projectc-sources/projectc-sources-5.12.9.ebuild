...
DESCRIPTION="Project-C CPU Scheduler And MuQSS CPU Scheduler patchset for the main kernel tree"
HOMEPAGE="https://github.com/Frogging-Family/linux-tkg"
LICENSE+=" CDDL"
SRC_URI="${KERNEL_BASE_URI}/linux-5.12.tar.xz
https://cdn.kernel.org/pub/linux/kernel/v5.x/patch-5.12.9.xz
${GENPATCHES_URI}
"

src_unpack() {
	UNIPATCH_LIST_DEFAULT=""
	UNIPATCH_LIST="${DISTDIR}/patch-5.12.9.xz"
