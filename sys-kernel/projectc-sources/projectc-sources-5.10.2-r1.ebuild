...
LICENSE+=" CDDL"
SRC_URI="${KERNEL_BASE_URI}/linux-5.10.tar.xz https://github.com/HougeLangley/customkernel/releases/download/Kernel-5.10-Patches/0001-patch-5.10.2.xz https://github.com/HougeLangley/customkernel/releases/download/Kernel-5.10-Patches/0002-prjc_v5.10-r1.xz ${GENPATCHES_URI}"

UNIPATCH_LIST_DEFAULT=""
UNIPATCH_LIST="${DISTDIR}/0001-patch-5.10.2.xz ${DISTDIR}/0002-prjc_v5.10-r1.xz"
