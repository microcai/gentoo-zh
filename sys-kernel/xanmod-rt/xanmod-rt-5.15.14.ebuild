...
${GENPATCHES_URI}
https://github.com/xanmod/linux/releases/download/5.15.14-rt27-xanmod1/patch-5.15.14-rt27-xanmod1.xz
...
UNIPATCH_LIST="${DISTDIR}/patch-5.15.14-rt27-xanmod1.xz ${DISTDIR}/v1-cjktty.patch.xz"
