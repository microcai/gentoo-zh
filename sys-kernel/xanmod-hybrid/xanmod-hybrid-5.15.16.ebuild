...
${GENPATCHES_URI}
https://github.com/HougeLangley/customkernel/releases/download/v5.15-patch/patch-5.15.16-xanmod1
https://github.com/HougeLangley/customkernel/releases/download/v5.15-patch/patch-5.15.16-xanmod1-tt
...
"${DISTDIR}/patch-5.15.16-xanmod1-tt"
...
src_prepare() {
	...
	if	use	cacule	;	then
		eapply "${DISTDIR}/patch-5.15.16-xanmod1-tt"	||	die
		eapply "${DISTDIR}/v1-cjktty-5.15.patch"	||	die
	fi
