...
${GENPATCHES_URI}
https://github.com/HougeLangley/customkernel/releases/download/v5.13-patch/patch-5.13.5-xanmod1
https://github.com/HougeLangley/customkernel/releases/download/v5.13-patch/patch-5.13.5-xanmod1-cacule
...
PATCHES=( "${DISTDIR}/patch-5.13.5-xanmod1"
"${DISTDIR}/patch-5.13.5-xanmod1-cacule"
