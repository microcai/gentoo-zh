...
${GENPATCHES_URI}
https://github.com/HougeLangley/customkernel/releases/download/v5.14-patch/patch-5.14.9-xanmod1
...
PATCHES=( "${DISTDIR}/patch-5.14.9-xanmod1"
...
src_prepare() {
	...
	if	use	xanmod	;	then
		eapply "${DISTDIR}/patch-5.14.9-xanmod1"	||	die
