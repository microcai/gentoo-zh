...
${GENPATCHES_URI}
https://github.com/HougeLangley/customkernel/releases/download/v5.14-patch/patch-5.14.5-xanmod1
https://github.com/HougeLangley/customkernel/releases/download/v5.14-patch/patch-5.14.5-xanmod1-cacule
...
PATCHES=( "${DISTDIR}/patch-5.14.5-xanmod1"
"${DISTDIR}/patch-5.14.5-xanmod1-cacule"
"${DISTDIR}/750HZ.patch"
