...
${GENPATCHES_URI}
https://github.com/HougeLangley/customkernel/releases/download/v5.13-patch/patch-5.13.13-xanmod1
...
PATCHES=( "${DISTDIR}/patch-5.13.13-xanmod1"
...
src_prepare() {
	...
	if	use	xanmod	;	then
		eapply "${DISTDIR}/patch-5.13.13-xanmod1"	||	die
