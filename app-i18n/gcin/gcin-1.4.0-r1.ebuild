...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "${FILESDIR}/gcin-FF3_gtkim.patch"
	# apply gcc34 patch
...
pkg_postinst() {
	einfo "If your experience dysfunction in the searchbox and URL,"
	einfo "please turn on the 'popup window' with gcin-setup. This "
	einfo "will inactive the new gtk-im, which is prone to this    "
	einfo "issue. For more information, please visit               "
	einfo "http://forums.gentoo.tw/								   "
}
