...
https://download.fcitx-im.org/data/dict.utf8-20200613.tar.xz -> fcitx5-dict.utf8-20200613.tar.xz
...
src_prepare() {
	...
	ln -s "${DISTDIR}/fcitx5-dict.utf8-20200613.tar.xz" data/dict.utf8-20200613.tar.xz || die
