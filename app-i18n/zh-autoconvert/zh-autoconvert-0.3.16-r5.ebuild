...
src_prepare() {
	...
	# Make it respect compiler preferences ^_^
	sed -i -e 's:CFLAG=-O2 -g -Wall -Iinclude:CFLAG+=-O2 -g -Wall -Iinclude:' Makefile
	sed -i -e 's:CFLAGS=-O2 -Wall -g -D_REENTRANT:CFLAGS+=-O2 -Wall -g -D_REENTRANT:' hzconvert/Makefile
