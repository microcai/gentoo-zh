...
"github.com/katzenpost/core v0.0.7 h1:ZI4oYACe/3n2iS2XsCccGbTFdhhRJunjFW05Utwna+g="
...
SRC_URI="https://github.com/cloudreve/Cloudreve/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz
${EGO_SUM_SRC_URI}
https://github.com/cloudreve/frontend/archive/59890e6b22d69befa8b742a64967b6bab1bb4a3d.tar.gz -> ${PN}-web-${PV}.tar.gz
"
...
COMMIT_SHA="db7489fb612f8227beaef874ca4c7cb2a6bafcc1"

src_unpack(){
    unpack ${P}.tar.gz
    unpack ${PN}-web-${PV}.tar.gz
#    cp ${FILESDIR}/static.go $S/bootstrap/static.go
...
src_compile(){
    ...
    ../../homedir/go/bin/statik -src=assets/build/  -include=*.html,*.js,*.json,*.css,*.png,*.svg,*.ico,*.ttf -f
