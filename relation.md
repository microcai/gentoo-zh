...
(The last generation time: 2025-03-23 18:30:43 CST)
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-dicts/fcitx-pinyin-moegirl             | 20250309         |            | https://github.com/outloudvi/mw2fcitx                                                   | Fcitx 5 Pinyin Dictionary from zh.moegirl.org.cn
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-dicts/fcitx-pinyin-moegirl-bin         | 20250309         |            | https://github.com/outloudvi/mw2fcitx                                                   | Fcitx 5 Pinyin Dictionary from zh.moegirl.org.cn
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-dicts/fcitx-pinyin-sougou-baidu        | 20250219         |            | https://github.com/blackteahamburger/fcitx5-pinyin-sougou-baidu                         | Sougou & Baidu Pinyin dictionary for Fcitx5 and RIME
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-dicts/fcitx-pinyin-zhwiki-bin          | 0.2.5.20250310   |            | https://github.com/felixonmars/fcitx5-pinyin-zhwiki                                     | Fcitx 5 Pinyin Dictionary from zh.wikipedia.org
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-editors/appflowy-bin                   | 0.8.7            |            | https://www.appflowy.io/                                                                | AppFlowy is an open-source alternative to Notion
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-i18n/fcitx-cskk                        | 1.2.0            |            | https://github.com/fcitx/fcitx5-cskk                                                    | SKK input method plugin for fcitx5 that uses LibCSKK
   app-i18n/cskk                            | 3.1.5            |  D, RD     | https://github.com/naokiri/cskk                                                         | C ABIから使う事を目的とした SKK(Simple Kana Kanji henkan)方式のかな漢字変換ライブラリ
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-misc/yazi                              | 25.3.2           |            | https://yazi-rs.github.io                                                               | Blazing fast terminal file manager written in Rust, based on async I/O.
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-db/dbeaver-bin                         | 25.0.0           |            | https://dbeaver.io/                                                                     | Free universal database tool (community edition).
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-python/conda                           | 25.1.1           |            | https://conda.io/                                                                       | OS-agnostic, system-level binary package manager and ecosystem
   dev-python/conda-libmamba-solver         | 25.1.1           |  D, RD     | https://github.com/conda/conda-libmamba-solver                                          | The libmamba based solver for conda
     dev-util/mamba                         | 2.0.5            | RD         | https://github.com/mamba-org/mamba                                                      | The Fast Cross-Platform Package Manager
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/vfox                              | 0.6.3            |            | https://vfox.lhan.me                                                                    | A cross-platform version manager, extendable via plugins
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/vfox-bin                          | 0.6.3            |            | https://vfox.lhan.me/                                                                   | A cross-platform version manager, extendable via plugins
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-fonts/lxgw-neo-xihei                 | 1.215            |            | https://github.com/lxgw/LxgwNeoXiHei                                                    | A Chinese sans-serif font derived from IPAex Gothic.
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-fonts/sarasa-gothic                  | 1.0.29           |            | https://github.com/be5invis/Sarasa-Gothic                                               | A CJK programming font based on Iosevka and Source Han Sans. (TTC)
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-gfx/bambustudio-bin                  | 01.10.02.76      |            | https://bambulab.com                                                                    | Bambu Studio is a cutting-edge, feature-rich slicing software
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-sound/spotube-bin                    | 4.0.2            |            | https://github.com/KRTirtho/spotube                                                     | A lightweight Spotify client using YouTube as audio source
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-sound/termusic                       | 0.10.0           |            | https://github.com/tramhao/termusic                                                     | Terminal Music and Podcast Player written in Rust
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-video/bilibili                       | 1.16.3_p1        |            | https://github.com/msojocs/bilibili-linux                                               | Based on the Bilibli offcial client to linux version, support roaming
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-dns/ddns-go                            | 6.9.1            |            | https://github.com/jeessy2/ddns-go                                                      | Automatically obtain your public IP address and set to your domain name service.
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/apifox                            | 2.7.2            |            | https://www.apifox.cn/                                                                  | API 文档、API 调试、API Mock、API 自动化测试
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/remmina-plugin-rustdesk           | 1.0.0.0-r1       |            | http://www.muflone.com/remmina-plugin-rustdesk/                                         | A protocol plugin for Remmina to launch a Rustdesk connection.
   net-misc/rustdesk                        | 1.3.8            |  D, RD     | https://rustdesk.com/                                                                   | An open-source remote desktop, and alternative to TeamViewer.
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/reqable                           | 2.33.5           |            | https://reqable.com/                                                                    | Reqable = Fiddler + Charles + Postman, 让API调试更快 🚀 更简单 👌
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/clash-nyanpasu                   | 1.5.1            |            | https://github.com/LibNyanpasu/clash-nyanpasu                                           | Clash GUI based on tauri
   ...
   net-proxy/mihomo                         | 1.19.3           |  D, RD     | https://wiki.metacubex.one/                                                             | Another Clash Kernel, formerly Clash.Meta
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/metacubexd                       | 1.186.1          |            | https://github.com/MetaCubeX/metacubexd                                                 | The Official Mihomo Dashboard
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/shadowsocks-rust                 | 1.23.0           |            | https://github.com/shadowsocks/shadowsocks-rust                                         | shadowsocks is a fast tunnel proxy that helps you bypass firewalls.
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 sys-apps/isd                               | 0.5.1            |            | https://github.com/isd-project/isd                                                      | isd (interactive systemd) — a better way to work with systemd units
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 sys-boot/ventoy-bin                        | 1.1.05           |            | http://www.ventoy.net                                                                   | A new multiboot USB solution
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 sys-kernel/cachyos-sources                 | 6.13.7           |            | https://cachyos.org                                                                     | Full Cachyos sources including the Gentoo patchset for the . kernel tree
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-apps/cherry-studio-bin                 | 1.1.8            |            | https://github.com/CherryHQ/cherry-studio                                               | Cherry Studio is a desktop client that supports for multiple LLM providers.
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-apps/follow-bin                        | 0.3.12           |            | https://follow.is/                                                                      | Next generation information browser
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-client/brave-bin                       | 1.76.81          |            | https://brave.com/                                                                      | Web browser that blocks ads and trackers by default
--------------------------------------------|------------------|------------|-----------------------------------------------------------------------------------------|--------------------
