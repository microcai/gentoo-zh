...
(The last generation time: 2025-01-11 16:46:50 CST)
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-vcs/sourcegit-bin                      | 2025.01             |            | https://github.com/sourcegit-scm/sourcegit                                              | Opensource Git GUI client.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-im/tencent-qq                          | 3.2.15_p241224-r3   |            | https://im.qq.com/linuxqq/index.shtml                                                   | The new version of the official linux-qq
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/apifox                            | 2.6.43              |            | https://www.apifox.cn/                                                                  | API 文档、API 调试、API Mock、API 自动化测试
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/hoppscotch-bin                    | 24.12.0.0           |            | https://hoppscotch.io                                                                   | Open source API development ecosystem
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/remmina-plugin-rustdesk           | 1.0.0.0-r1          |            | http://www.muflone.com/remmina-plugin-rustdesk/                                         | A protocol plugin for Remmina to launch a Rustdesk connection.
   net-misc/rustdesk                        | 1.3.6               |  D, RD     | https://rustdesk.com/                                                                   | An open-source remote desktop, and alternative to TeamViewer.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/shadowsocks-rust                 | 1.21.2              |            | https://github.com/shadowsocks/shadowsocks-rust                                         | shadowsocks is a fast tunnel proxy that helps you bypass firewalls.
                                            | 1.22.0              |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/sing-box                         | 1.10.6              |            | https://sing-box.sagernet.org/                                                          | The universal proxy platform.
                                            | 1.9.7               |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-apps/follow-bin                        | 0.3.1_beta0         |            | https://follow.is/                                                                      | Next generation information browser
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-apps/lzc-client-desktop                | 1.1.6               |            | https://lazycat.cloud                                                                   | Next generation information browser
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-client/brave-bin                       | 1.73.105            |            | https://brave.com/                                                                      | Web browser that blocks ads and trackers by default
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
