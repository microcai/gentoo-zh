...
(The last generation time: 2024-12-17 21:29:17 CST)
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-editors/appflowy-bin                   | 0.7.7               |            | https://www.appflowy.io/                                                                | AppFlowy is an open-source alternative to Notion
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-editors/cursor                         | 0.43.6              |            | https://www.cursor.com/                                                                 | Cursor App - AI-first coding environment
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-i18n/fcitx-cskk                        | 1.2.0               |            | https://github.com/fcitx/fcitx5-cskk                                                    | SKK input method plugin for fcitx5 that uses LibCSKK
   app-i18n/cskk                            | 3.1.2               |  D, RD     | https://github.com/naokiri/cskk                                                         | C ABIから使う事を目的とした SKK(Simple Kana Kanji henkan)方式のかな漢字変換ライブラリ
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-misc/go-yq-bin                         | 4.44.6              |            | https://github.com/mikefarah/yq                                                         | yq is a portable command-line YAML, JSON and XML processor
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-misc/xmind                             | 24.10.01101         |            | https://www.xmind.net                                                                   | Brainstorming and Mind Mapping Software
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-misc/yazi                              | 0.4.1               |            | https://yazi-rs.github.io                                                               | Blazing fast terminal file manager written in Rust, based on async I/O.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-cpp/date                               | 3.0.3               |            | https://github.com/HowardHinnant/date                                                   | A date and time library based on the C++11/14/17 <chrono> header
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-db/dbeaver-bin                         | 24.3.0              |            | https://dbeaver.io/                                                                     | Free universal database tool (community edition).
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-debug/lldb-mi                          | 0.0.1               |            | https://github.com/lldb-tools/lldb-mi                                                   | LLDB Machine Interface Driver
                                            | 9999                |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-java/google-java-format                | 1.25.0              |            | https://github.com/google/google-java-format                                            | Reformats Java source code to comply with Google Java Style.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-python/conda                           | 24.5.0              |            | https://conda.io/                                                                       | OS-agnostic, system-level binary package manager and ecosystem
   dev-python/conda-libmamba-solver         | 24.11.0             |  D, RD     | https://github.com/conda/conda-libmamba-solver                                          | The libmamba based solver for conda
     dev-util/mamba                         | 1.5.10              | RD         | https://github.com/mamba-org/mamba                                                      | The Fast Cross-Platform Package Manager
       ...
       sys-libs/libsolv                     | 0.7.31              |  D, RD     | https://github.com/openSUSE/libsolv                                                     | Library for solving packages and reading repositories
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-python/nvchecker                       | 2.16                |            | https://pypi.org/project/nvchecker/                                                     | nvchecker is for checking if a new version of some software has been released
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/android-studio                    | 2024.2.1.12         |            | https://developer.android.com/studio                                                    | Android development environment based on IntelliJ IDEA
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
   ...
   dev-util/pacstrap                        | 29                  | RD         | https://github.com/archlinux/arch-install-scripts                                       | Pacstrap - install packages to the specified new root directorye
     sys-apps/pacman                        | 7.0.0               |  D         | https://archlinux.org/pacman/                                                           | Archlinux's binary package manager
       app-crypt/archlinux-keyring          | 20231113            |  D, RD     | https://gitlab.archlinux.org/archlinux/archlinux-keyring                                | GnuPG keyring of Archlinux developer keys
                                            ...
                                            | 20240208-r1         |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/asdf-vm                           | 0.14.1              |            | https://github.com/asdf-vm/asdf                                                         | Manage all your runtime versions with one tool
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/jetbrains-toolbox                 | 1.28.1.15219        |            | https://www.jetbrains.com/toolbox/app                                                   | Manage all your JetBrains Projects and Tools
                                            | 2.5.2.35332         |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/mongodb-compass-bin               | 1.45.0              |            | https://mongodb.com/compass                                                             | The GUI for MongoDB
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-vcs/gitoxide                           | 0.39.0              |            | https://github.com/GitoxideLabs/gitoxide                                                | A command-line application for interacting with git repositories
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-vcs/sourcegit-bin                      | 8.43                |            | https://github.com/sourcegit-scm/sourcegit                                              | Opensource Git GUI client.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 games-action/vintagestory                  | 1.19.8              |            | https://www.vintagestory.at/                                                            | Uncompromising wilderness survival sandbox game (requires paid account)
                                            | 1.20.0_rc5          |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 games-arcade/osu-lazer                     | 2024.1208.0         |            | https://osu.ppy.sh                                                                      | rhythm is just a *click* away!
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-fonts/lxgw-neo-xihei                 | 1.211               |            | https://github.com/lxgw/LxgwNeoXiHei                                                    | A Chinese sans-serif font derived from IPAex Gothic.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-fonts/lxgw-neo-zhisong               | 1.021               |            | https://github.com/lxgw/LxgwNeoZhiSong                                                  | An open-source Chinese font derived from IPAmj Mincho
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-fonts/sarasa-gothic                  | 1.0.25              |            | https://github.com/be5invis/Sarasa-Gothic                                               | A CJK programming font based on Iosevka and Source Han Sans. (TTC)
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-gfx/bambustudio-bin                  | 01.10.01.50         |            | https://bambulab.com                                                                    | Bambu Studio is a cutting-edge, feature-rich slicing software
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-sound/lx-music-desktop-bin           | 2.9.0               |            | https://github.com/lyswhut/lx-music-desktop                                             | 一个基于 electron 的音乐软件
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-sound/spotube-bin                    | 3.9.0               |            | https://github.com/KRTirtho/spotube                                                     | A lightweight Spotify client using YouTube as audio source
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-dns/ddns-go                            | 6.7.7               |            | https://github.com/jeessy2/ddns-go                                                      | Automatically obtain your public IP address and set to your domain name service.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-fs/mc                                  | 2024.11.21.17.21.54 |            | https://github.com/minio/mc                                                             | Minio client provides alternatives for ls, cat on cloud storage and filesystems
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-im/wechat                              | 4.0.1.7             |            | https://linux.weixin.qq.com                                                             | Weixin for Linux
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/apifox                            | 2.5.19              |            | https://www.apifox.cn/                                                                  | API 文档、API 调试、API Mock、API 自动化测试
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/biliup-app                        | 0.4.1-r4            |            | https://github.com/ForgQi/biliup-app                                                    | A Tool for Upload video to bilibili
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/biliup-app-bin                    | 0.5.3               |            | https://github.com/ForgQi/biliup-app                                                    | A Tool for Upload video to bilibili
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/hoppscotch-bin                    | 24.11.0.0           |            | https://hoppscotch.io                                                                   | Open source API development ecosystem
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/remmina-plugin-rustdesk           | 1.0.0.0-r1          |            | http://www.muflone.com/remmina-plugin-rustdesk/                                         | A protocol plugin for Remmina to launch a Rustdesk connection.
   net-misc/rustdesk                        | 1.3.3               |  D, RD     | https://rustdesk.com/                                                                   | An open-source remote desktop, and alternative to TeamViewer.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/clash-verge-bin                  | 1.6.0               |            | https://github.com/clash-verge-rev/clash-verge-rev                                      | (Continuation) of Clash Meta GUI based on Tauri.
                                            ...
                                            | 2.0.2               |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/dae                              | 0.8.0               |            | https://github.com/daeuniverse/dae                                                      | A lightweight and high-performance transparent proxy solution based on eBPF
                                            | 0.9.0_rc1           |            |                                                                                         |
                                            | 9999                |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/daed                             | 0.8.0               |            | https://github.com/daeuniverse/daed                                                     | A Modern Dashboard For dae
                                            | 9999                |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/hysteria                         | 2.6.0               |            | https://github.com/apernet/hysteria                                                     | A powerful, lightning fast and censorship resistant proxy.
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/metacubexd                       | 1.174.0             |            | https://github.com/MetaCubeX/metacubexd                                                 | The Official Mihomo Dashboard
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/mihomo-party-bin                 | 1.5.12              |            | https://mihomo.party                                                                    | Mihomo Party
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/shadowsocks-rust                 | 1.21.0              |            | https://github.com/shadowsocks/shadowsocks-rust                                         | A Rust port of shadowsocks.
                                            | 1.21.2              |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/sing-box                         | 1.10.3              |            | https://sing-box.sagernet.org/                                                          | The universal proxy platform.
                                            | 1.9.7               |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/v2rayA                           | 2.2.6.3             |            | https://v2raya.org/                                                                     | web GUI of Project V which supports V2Ray, Xray, SS, SSR, Trojan and Pingtunnel
                                            | 9999                |            |                                                                                         |
   net-proxy/Xray                           | 24.11.21            | RD         | https://xtls.github.io/                                                                 | Xray, Penetrates Everything. Also the best v2ray-core, with XTLS support.
                                            | 24.11.30            |            |                                                                                         |
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-vpn/cloudflared-bin                    | 2024.12.1           |            | https://github.com/cloudflare/cloudflared                                               | Cloudflare Tunnel client (formerly Argo Tunnel)
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-apps/follow-bin                        | 0.2.7_beta0-r2      |            | https://follow.is/                                                                      | Next generation information browser
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-apps/lzc-client-desktop                | 1.1.2-r1            |            | https://lazycat.cloud                                                                   | Next generation information browser
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-client/brave-bin                       | 1.73.101            |            | https://brave.com/                                                                      | Web browser that blocks ads and trackers by default
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
