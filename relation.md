...
(The last generation time: 2025-02-06 22:15:26 CST)
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-dicts/fcitx-pinyin-moegirl-bin         | 20250113            |            | https://github.com/outloudvi/mw2fcitx                                                   | Fcitx 5 Pinyin Dictionary from zh.moegirl.org.cn
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-dicts/fcitx-pinyin-sougou-baidu        | 20250122            |            | https://github.com/blackteahamburger/fcitx5-pinyin-sougou-baidu                         | Sougou & Baidu Pinyin dictionary for Fcitx5 and RIME
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 app-editors/appflowy-bin                   | 0.8.3               |            | https://www.appflowy.io/                                                                | AppFlowy is an open-source alternative to Notion
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-db/dbeaver-bin                         | 24.3.4              |            | https://dbeaver.io/                                                                     | Free universal database tool (community edition).
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-python/conda                           | 24.5.0              |            | https://conda.io/                                                                       | OS-agnostic, system-level binary package manager and ecosystem
   dev-python/conda-libmamba-solver         | 24.11.1             |  D, RD     | https://github.com/conda/conda-libmamba-solver                                          | The libmamba based solver for conda
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/pack-cli-bin                      | 0.36.4              |            | https://buildpacks.io                                                                   | CLI for building apps using Cloud Native Buildpacks
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/vfox                              | 0.6.0               |            | https://vfox.lhan.me                                                                    | A cross-platform version manager, extendable via plugins
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 dev-util/vfox-bin                          | 0.6.0               |            | https://vfox.lhan.me/                                                                   | A cross-platform version manager, extendable via plugins
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 games-util/winegame-client-bin             | 0.5.10.5            |            | https://winegame.net/                                                                   | An open source gaming platform for GNU/Linux
                                            | 0.5.12.2            |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 gui-apps/crystal-dock                      | 2.7                 |            | https://github.com/dangvd/crystal-dock                                                  | Cool dock (desktop panel) for Linux desktop
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-fonts/lxgw-neo-xihei                 | 1.212               |            | https://github.com/lxgw/LxgwNeoXiHei                                                    | A Chinese sans-serif font derived from IPAex Gothic.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-fonts/lxgw-neo-zhisong               | 1.023               |            | https://github.com/lxgw/LxgwNeoZhiSong                                                  | An open-source Chinese font derived from IPAmj Mincho
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-fonts/sarasa-gothic                  | 1.0.28              |            | https://github.com/be5invis/Sarasa-Gothic                                               | A CJK programming font based on Iosevka and Source Han Sans. (TTC)
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-sound/ytmdesktop-bin                 | 2.0.7               |            | https://github.com/ytmdesktop/ytmdesktop                                                | A Desktop App for YouTube Music
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 media-video/bilibili                       | 1.16.2_p3           |            | https://github.com/msojocs/bilibili-linux                                               | Based on the Bilibli offcial client to linux version, support roaming
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-dns/ddns-go                            | 6.8.1               |            | https://github.com/jeessy2/ddns-go                                                      | Automatically obtain your public IP address and set to your domain name service.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-fs/mc                                  | 2025.02.04.04.57.50 |            | https://github.com/minio/mc                                                             | Minio client provides alternatives for ls, cat on cloud storage and filesystems
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/apifox                            | 2.6.47              |            | https://www.apifox.cn/                                                                  | API 文档、API 调试、API Mock、API 自动化测试
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/hoppscotch-bin                    | 25.1.0.0            |            | https://hoppscotch.io                                                                   | Open source API development ecosystem
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-misc/remmina-plugin-rustdesk           | 1.0.0.0-r1          |            | http://www.muflone.com/remmina-plugin-rustdesk/                                         | A protocol plugin for Remmina to launch a Rustdesk connection.
   net-misc/rustdesk                        | 1.3.7               |  D, RD     | https://rustdesk.com/                                                                   | An open-source remote desktop, and alternative to TeamViewer.
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/clash-nyanpasu                   | 1.5.1               |            | https://github.com/LibNyanpasu/clash-nyanpasu                                           | Clash GUI based on tauri
   ...
   sys-apps/pnpm                            | 9.15.4              | BD         | https://pnpm.io                                                                         | Fast, disk space efficient package manager
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/daed                             | 0.9.0               |            | https://github.com/daeuniverse/daed                                                     | A Modern Dashboard For dae
                                            | 9999                |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/hysteria                         | 2.6.1               |            | https://github.com/apernet/hysteria                                                     | A powerful, lightning fast and censorship resistant proxy.
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/metacubexd                       | 1.176.2             |            | https://github.com/MetaCubeX/metacubexd                                                 | The Official Mihomo Dashboard
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/mihomo-party-bin                 | 1.6.0               |            | https://mihomo.party                                                                    | Mihomo Party
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-proxy/naiveproxy-bin                   | 132.0.6834.79_p2    |            | https://github.com/klzgrad/naiveproxy                                                   | A proxy using Chromium's network stack to camouflage traffic
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 net-vpn/cloudflared-bin                    | 2025.1.1            |            | https://github.com/cloudflare/cloudflared                                               | Cloudflare Tunnel client (formerly Argo Tunnel)
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 sci-electronics/lceda                      | 6.5.37              |            | https://lceda.cn/                                                                       | LCEDA (binary package)
                                            | 6.5.46              |            |                                                                                         |
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 sci-electronics/lceda-pro                  | 2.2.35.1            |            | https://lceda.cn/                                                                       | LCEDA Pro (binary package)
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
...
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-client/brave-bin                       | 1.74.51             |            | https://brave.com/                                                                      | Web browser that blocks ads and trackers by default
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
 www-client/thorium-browser-bin             | 128.0.6613.189      |            | https://thorium.rocks                                                                   | Chromium fork focused on high performance and security
--------------------------------------------|---------------------|------------|-----------------------------------------------------------------------------------------|--------------------
