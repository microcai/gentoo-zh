...
declare -r -A ZBS_DEPENDENCIES=(
	...
	[mach_glfw-12206ed982e709e565d536ce930701a8c07edfd2cfdce428683f3f2a601d37696a62.tar.gz]='https://github.com/mitchellh/mach-glfw/archive/37c2995f31abcf7e8378fba68ddcf4a3faa02de0.tar.gz'
	[zig_objc-1220e17e64ef0ef561b3e4b9f3a96a2494285f2ec31c097721bf8c8677ec4415c634.tar.gz]='https://github.com/mitchellh/zig-objc/archive/9b8ba849b0f58fe207ecd6ab7c147af55b17556e.tar.gz'
	...
	[libpng-1220aa013f0c83da3fb64ea6d327f9173fa008d10e28bc9349eac3463457723b1c66.tar.gz]='https://github.com/glennrp/libpng/archive/refs/tags/v1.6.43.tar.gz'
	...
	[utf8proc-1220056ce228a8c58f1fa66ab778f5c8965e62f720c1d30603c7d534cb7d8a605ad7.tar.gz]='https://github.com/JuliaStrings/utf8proc/archive/refs/tags/v2.8.0.tar.gz'
...
"
SRC_URI="
	https://github.com/ghostty-org/ghostty/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
...
PATCHES=(
	"${FILESDIR}"/${P}-link-bz2.patch
)

src_prepare() {
	# https://github.com/ghostty-org/ghostty/blob/a8e5eef1/build.zig#L487
	# a wordaround for terminfo install failed
	mkdir -pv usr/share || die
